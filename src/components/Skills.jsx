...
const Skills = () => {
    return (
        <div className="bg-[#171717] text-white" id='skills'>
            <h2 className="text-5xl text-[#f3004b] fancy text-center pt-5 pb-1 w-48 mx-auto">Skills</h2>
            ...
            <div data-aos="fadeInUp" data-aos-easing="linear" data-aos-duration="1000" className="grid grid-cols-2 lg:grid-cols-3 gap-10 mx-5 lg:mx-16 py-10 aos-init aos-animate">
                <div className="shadow-md hover:scale-105 duration-500 py-2 rounded-lg shadow-orange-500 flex flex-col items-center">
                    <img className="w-20" src={html} alt="" />
                    <p className="text-xl mt-2">HTML</p>
                </div>
                <div className="shadow-md hover:scale-105 duration-500 py-2 rounded-lg shadow-blue-500 flex flex-col items-center">
                    <img className="w-20" src={css} alt="" />
                    <p className="text-xl mt-2">CSS</p>
                </div>
                <div className="shadow-md hover:scale-105 duration-500 py-2 rounded-lg shadow-purple-500 flex flex-col items-center">
                    <img className="w-20" src={bootstrap} alt="" />
                    <p className="text-xl mt-2">Bootstrap</p>
                </div>
                <div className="shadow-md hover:scale-105 duration-500 py-2 rounded-lg shadow-sky-500 flex flex-col items-center">
                    <img className="w-20" src={tailwind} alt="" />
                    <p className="text-xl mt-2">Tailwind</p>
                </div>
                <div className="shadow-md hover:scale-105 duration-500 py-2 rounded-lg shadow-yellow-500 flex flex-col items-center">
                ...
                <div className="shadow-md hover:scale-105 duration-500 py-2 rounded-lg shadow-lime-500 flex flex-col items-center">
                    <img className="w-20" src={node} alt="" />
                    <p className="text-xl mt-2">Node. Js</p>
                </div>
                <div className="shadow-md hover:scale-105 duration-500 py-2 rounded-lg shadow-gray-500 flex flex-col items-center">
                    <img className="w-20" src={express} alt="" />
                    <p className="text-xl mt-2">Express. Js</p>
                </div>
                <div className="shadow-md hover:scale-105 duration-500 py-2 rounded-lg shadow-green-500 flex flex-col items-center">
                ...
                <div className="shadow-md hover:scale-105 duration-500 py-2 rounded-lg shadow-red-500 flex flex-col items-center">
